...
<body class="background">
    ...
    <div class="d-flex justify-content-center container h-100">
        ...
        <div class="align-self-center mb-5 text-center">
            <h1>~</h1>
            <h2>Votre compte a été créé. Veuillez attendre la validation de votre compte par un gestionnaire pour pouvoir vous connecter.
            </h2>
            <h5>Votre nom d'utilisateur correspond à : première lettre de votre prénom + nom de famille (ex : Guy Tard -> gtard)</h5>
